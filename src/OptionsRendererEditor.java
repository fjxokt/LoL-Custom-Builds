...
public class OptionsRendererEditor extends AbstractCellEditor implements TableCellRenderer, TableCellEditor
{
    ...
    public OptionsRendererEditor() {
        ...
        add = new JButton(ResourcesManager.getInst().getIcon("add.png", true));
        add.setToolTipText(LocaleString.string("Create new build"));
        add.setPreferredSize(new Dimension(18,18));
        add.setFocusPainted(false);
        add.setBorderPainted(false);
        remove = new JButton(ResourcesManager.getInst().getIcon("remove.png", true));
        ...
        add.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				((LoLTableModel)tableau.getModel()).createBuild(champ, LoLCustomBuildsManager.getInst().getMode());
			}
        });
        ...
        remove.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				((LoLTableModel)tableau.getModel()).removeBuild(champ, LoLCustomBuildsManager.getInst().getMode(), build);
			}
        });
